...
{{--     
 ...
 {{-- here --}}
            ...
            <nav class="mt-10">
                <a class="{{(Route::currentRouteName()==='admin')?' flex justify-end mt-4 py-2 px-6 bg-gray-700 bg-opacity-25 text-gray-100' :'flex justify-end mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100'}}" href="{{ route('admin') }}">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="22.5" height="23.992" viewBox="0 0 22.5 23.992">
                        <path id="man-head" d="M15.993,11.5a1.5,1.5,0,1,1-1.5-1.5,1.5,1.5,0,0,1,1.5,1.5Zm8,0a3.5,3.5,0,0,0-2.15-3.226A10,10,0,0,0,2.219,7.9L1.5,12s1.606,0,1.778-.013a12.19,12.19,0,0,0,4.9-1.191,1.484,1.484,0,0,0-.183.7A1.5,1.5,0,1,0,9.62,10.013c.025-.016.052-.03.077-.045A16.228,16.228,0,0,0,16.114,3.14a7.966,7.966,0,0,1,3.833,6.009l.078.746.738.133a1.5,1.5,0,0,1,1.23,1.472H22A1.5,1.5,0,0,1,20.5,13a1.606,1.606,0,0,1-.252-.027l-.835-.148-.282.8C18.215,16.221,15.13,19,12,19h0c-3.026,0-6.023-2.619-7.041-5.153A13.535,13.535,0,0,1,3,14H2.88c.062.181.106.3.12.339a10.894,10.894,0,0,0,5,5.6V24h8V19.954a11.037,11.037,0,0,0,4.732-4.962A3.5,3.5,0,0,0,24,11.5Z" transform="translate(-1.5 -0.008)" fill="#8ecae6"/>
                      </svg>
                ...
                <a class="{{(Route::currentRouteName()==='section')?' flex justify-end mt-4 py-2 px-6 bg-gray-700 bg-opacity-25 text-gray-100' :'flex justify-end mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100'}}"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="19.947" height="19.947" viewBox="0 0 19.947 19.947">
                        <g id="Group_49" data-name="Group 49" transform="translate(-1.998 -2.055)">
                          <path id="Path_54" data-name="Path 54" d="M11,3.055A9,9,0,1,0,20.945,13H11Z" fill="none" stroke="#8ecae6" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/>
                          <path id="Path_55" data-name="Path 55" d="M20.488,9H15V3.512A9.025,9.025,0,0,1,20.488,9Z" fill="none" stroke="#8ecae6" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/>
                        </g>
                      </svg>
                ...
                href={{ route('projects') }}>
                    ...
                    <svg id="edit-alt" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <path id="Path_70" data-name="Path 70" d="M9.288,13.067c-2.317.446-3.465,3.026-3.963,4.634A1,1,0,0,0,6.281,19H10a3,3,0,0,0,2.988-3.274,3.107,3.107,0,0,0-3.7-2.659Z" fill="#8ecae6"/>
                        <path id="Path_71" data-name="Path 71" d="M23,8.979a1,1,0,0,0-1,1V15H18a3,3,0,0,0-3,3v4H5a3,3,0,0,1-3-3V5A3,3,0,0,1,5,2H16.042a1,1,0,1,0,0-2H5A5.006,5.006,0,0,0,0,5V19a5.006,5.006,0,0,0,5,5H16.343a4.966,4.966,0,0,0,3.535-1.464l2.658-2.658A4.966,4.966,0,0,0,24,16.343V9.979A1,1,0,0,0,23,8.979ZM18.464,21.122a3.022,3.022,0,0,1-1.464.8V18a1,1,0,0,1,1-1h3.925a3.022,3.022,0,0,1-.8,1.464Z" fill="#8ecae6"/>
                        <path id="Path_72" data-name="Path 72" d="M14.566,14.17a1,1,0,0,1-.707-1.707L21.712,4.61a.943.943,0,0,0,0-1.335A.9.9,0,0,0,21.018,3a.933.933,0,0,0-.678.314l-7.6,8.407a1,1,0,0,1-1.484-1.341l7.6-8.4A2.949,2.949,0,0,1,20.963,1a2.985,2.985,0,0,1,2.163.862,2.947,2.947,0,0,1,0,4.163l-7.853,7.853a.993.993,0,0,1-.707.292Z" fill="#8ecae6"/>
                      </svg>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24.001" height="24.024" viewBox="0 0 24.001 24.024">
                    <g id="comment" transform="translate(0.001 0.024)">
                      <path id="Path_66" data-name="Path 66" d="M24,11.247A12.012,12.012,0,1,0,12.017,24H19a5.005,5.005,0,0,0,5-5ZM22,19a3,3,0,0,1-3,3H12.017a10.041,10.041,0,0,1-7.476-3.343,9.917,9.917,0,0,1-2.476-7.814,10.043,10.043,0,0,1,8.656-8.761A10.564,10.564,0,0,1,12.021,2,9.921,9.921,0,0,1,18.4,4.3,10.041,10.041,0,0,1,22,11.342Z" fill="#8ecae6"/>
                      <path id="Path_67" data-name="Path 67" d="M8,9h4a1,1,0,0,0,0-2H8A1,1,0,0,0,8,9Z" fill="#8ecae6"/>
                      <path id="Path_68" data-name="Path 68" d="M16,11H8a1,1,0,0,0,0,2h8a1,1,0,0,0,0-2Z" fill="#8ecae6"/>
                      <path id="Path_69" data-name="Path 69" d="M16,15H8a1,1,0,0,0,0,2h8a1,1,0,0,0,0-2Z" fill="#8ecae6"/>
                    </g>
                  </svg>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="23.981" height="15.94" viewBox="0 0 23.981 15.94">
            <path id="engine-warning" d="M12,20a8.009,8.009,0,0,1-8-8C4.376,1.412,19.626,1.415,20,12a8.009,8.009,0,0,1-8,8ZM12,6c-7.929.252-7.928,11.749,0,12C19.929,17.748,19.928,6.251,12,6Zm1,2H11v5h2Zm0,6H11v2h2Zm11-2a12.026,12.026,0,0,0-2.743-7.637L19.714,5.637a10.052,10.052,0,0,1,0,12.726l1.543,1.274A12.026,12.026,0,0,0,24,12ZM4.286,18.363a10.052,10.052,0,0,1,0-12.726L2.744,4.363a12.065,12.065,0,0,0,0,15.274Z" transform="translate(-0.019 -4.06)" fill="#8ecae6"/>
          </svg>
