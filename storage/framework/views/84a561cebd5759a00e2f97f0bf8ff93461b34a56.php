    ...
    <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200 ">
        ...
        <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
            ...
            <nav class="mt-10">
                ...
                <a class="<?php echo e(Route::currentRouteName() === 'projects'? ' flex justify-end mt-4 py-2 px-6 bg-gray-700 bg-opacity-25 text-[#8ecae6]': 'flex justify-end mt-4 py-2 px-6 text-gray-300 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100'); ?>"
...
<?php /**PATH C:\Users\DELL\Desktop\EnjezLe\resources\views/Admin/layout/side.blade.php ENDPATH**/ ?>