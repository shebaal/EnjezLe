...
class WorkController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('providers.works.index',['data'=>$work]);
    }
    ...
    {
        return view('providers.works.create');
    }
    ...
    {
        $work=work::find($id);
        return view('providers.works.show',['data'=>$work]);
    }

    public function edit($id)
    {
        $work=work::find($id);
        return view('providers.works.edit',['data'=>$work]);
    }
